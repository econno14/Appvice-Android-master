...
import com.missedops.mainswipetabs.NavDrawerListAdapter;
import com.missedops.mainswipetabs.NavDrawerItem;

import com.missedops.mainfragments.*;
...
public class MainActivity extends FragmentActivity { //extends FragmentActivity
	...
	private void displayView(int position) {
		...
		switch (position) {
		case 0:
			fragment = new MyNetworksFragment();
			break;
		case 1:
			fragment = new AskFragment();
			break;
		case 2:
			fragment = new PQListFragment();
			break;
		case 3:
			fragment = new RQListFragment();
			break;
		case 4:
			fragment = new UQListFragment();
			break;
		case 5:
			fragment = new AQListFragment();
			break;
